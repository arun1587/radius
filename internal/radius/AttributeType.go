...
const (
	...
	LoraJoinRequest 			AttributeType = 193
	LoraJoinAccept 		 		AttributeType = 194
	LoraNwkSKey     			AttributeType = 195
	LoraAppSKey     			AttributeType = 196
...
var attributeTypeMap = [256]attributeTypeDesc{
	...
	LoraJoinRequest: 			{"LoraJoinRequest", avpBinary},
	LoraJoinAccept:		 		{"LoraJoinAccept", avpBinary},
	LoraNwkSKey:     			{"LoraNwkSKey", avpBinary},
	LoraAppSKey:     			{"LoraAppSKey", avpBinary},
